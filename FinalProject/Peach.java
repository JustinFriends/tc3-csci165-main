...
public class Peach extends Creature {
	...
	public Peach() {
		...
		this.setDefense(0);
		this.setMoveNumberOfSpaces(6);
		this.setSightRange(16);
		this.setAttackRange(3);
		this.setDefaultColor(255, 20, 147);
	}
	
	public Peach(int maxX, int maxY) {
		super(maxX, maxY);
		this.setHealth(150);
		this.setMaxHealth(150);
		this.setAttackPower(25);
		this.setDefaultAttackPower(25);
		this.setDefense(0);
		this.setDefaultDefense(0);
		this.setMoveNumberOfSpaces(6);
		this.setDefaultMoveNumberOfSpaces(6);
		this.setSightRange(16);
		this.setAttackRange(3);
		this.setDefaultColor(255, 20, 147);  //Deep pink.
	}
	
	public Peach(int health, int attackPower, int defense) {
		super(health, attackPower, defense);
	}
	
	public Peach(int health, int attackPower, int defense, Weapon equippeWeapon, Armor equippedArmor, 
	...
	/*@Override
	public void move() {
		System.out.println("Peach's move method was called.");
	}*/
	
	@Override
	public void attack(Creature creature) {
		System.out.println("Peach's attack method was called.");
	...
	public void observe(ArrayList<Creature> creatureProximity, ArrayList<Item> itemProximity) {
		System.out.println("Peach's observe method was called.");
